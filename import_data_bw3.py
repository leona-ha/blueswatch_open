...
use_data = 14 #  "all"==1 or "14_days_prior"=14 or bw3= 3
...
valid_users = questionnaire_sessions[
    (questionnaire_sessions.questionnaire == 33)
].user.unique()
...
dataFull.to_csv("%s/data_Full_bw3_%s.csv" % (data_out_directory, use_data), index=False)
